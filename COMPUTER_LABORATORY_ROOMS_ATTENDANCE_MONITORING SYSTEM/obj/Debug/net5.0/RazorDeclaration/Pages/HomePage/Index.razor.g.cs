...
namespace COMPUTER_LABORATORY_ROOMS_ATTENDANCE_MONITORING_SYSTEM.Pages.HomePage
{
    #line hidden
    using System;
...
#nullable restore
#line 8 "E:\Software Engineer files\Projects\COMPUTER_LABORATORY_ROOMS_ATTENDANCE_MONITORING SYSTEM\COMPUTER_LABORATORY_ROOMS_ATTENDANCE_MONITORING SYSTEM\Pages\HomePage\Index.razor"
       
    public void NavigatetoClassSchedule()
    {
        navManager.NavigateTo("/schedule");
    }
    public void NavigateToTimeInOut()
    {
        navManager.NavigateTo("/time");
    }
