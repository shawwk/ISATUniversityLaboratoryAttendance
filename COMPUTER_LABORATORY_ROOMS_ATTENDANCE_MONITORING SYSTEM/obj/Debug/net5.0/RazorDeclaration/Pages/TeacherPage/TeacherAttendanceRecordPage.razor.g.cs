...
#nullable disable
#nullable restore
#line 2 "E:\Software Engineer files\Projects\COMPUTER_LABORATORY_ROOMS_ATTENDANCE_MONITORING SYSTEM\COMPUTER_LABORATORY_ROOMS_ATTENDANCE_MONITORING SYSTEM\Pages\TeacherPage\TeacherAttendanceRecordPage.razor"
using System.Transactions;

#line default
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Components.RouteAttribute("/teacher/attendance")]
    public partial class TeacherAttendanceRecordPage : global::Microsoft.AspNetCore.Components.ComponentBase
    {
...
#nullable restore
#line 137 "E:\Software Engineer files\Projects\COMPUTER_LABORATORY_ROOMS_ATTENDANCE_MONITORING SYSTEM\COMPUTER_LABORATORY_ROOMS_ATTENDANCE_MONITORING SYSTEM\Pages\TeacherPage\TeacherAttendanceRecordPage.razor"
    ...
    async void MarkAbsent()
    {
        ...
        if (result != null)
        {
            if(sectionList.Count > 0)
            {
                ...
                var getClass = classService.GetClass(filterParam);
                foreach (var item in t)
                {
                    //timeService.MarkAbsent(item.StudentId, DateTime.Now.Date, sectionId);
                }
